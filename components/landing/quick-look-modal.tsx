...
import { BlurPanel } from "../ui/blur-panel"

interface ProductQuickLookSwatch {
  color: string
  name: string
}

interface ProductQuickLook {
  name: string
  quickLookImages: string[]
  materials: string[]
  price: string | number
  dimensions: string
  swatches: ProductQuickLookSwatch[]
}

interface QuickLookModalProps {
  product: ProductQuickLook | null
  isOpen: boolean
  onClose: () => void
}
                  ...
                  <div className="space-y-6 flex-1">
                    ...
                    <div>
                      ...
                      <div className="flex gap-3">
                        {product.swatches.map((swatch: ProductQuickLookSwatch, index: number) => (
                          <button
                            key={index}
